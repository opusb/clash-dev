...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/opusb/clash-dev/constant.Version=$(VERSION)" \
		-X "github.com/opusb/clash-dev/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
